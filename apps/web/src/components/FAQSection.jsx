...
export default function FAQSection() {
  ...
  return (
    <section className="bg-[#f0f2f8] font-[Inter,sans-serif]">
      <div className="w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[700px]">

          {/* Left Side */}
          <div className="py-12 px-6 sm:px-10 lg:px-14 flex flex-col justify-center">

            {/* Badge */}
            <span className="inline-block border border-gray-300 bg-white text-gray-500 text-sm px-5 py-1.5 rounded-full mb-6 w-fit font-[Inter,sans-serif]">
              FAQ
            </span>

            {/* Heading */}
            <h2
              className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#000073] leading-tight mb-3 font-[Inter,sans-serif]"
            >
              Taking you to the destination you want to reach in case
            </h2>
            <p className="text-gray-400 text-sm mb-8 sm:mb-10 font-[Inter,sans-serif]">Frequently asked questions!</p>
              ...
              {faqs.map((faq) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <span
                        className={`text-sm sm:text-base font-semibold transition-colors duration-200 pr-3 font-[Inter,sans-serif] ${
                        ...
                        >
                          <div className="px-5 sm:px-6 pb-5 pt-1">
                            {typeof faq.answer === "string" ? (
                              <p className="text-sm leading-relaxed text-red-100 font-[Inter,sans-serif]">
                                {faq.answer}
                              </p>
                            ) : (
                              faq.answer
          ...
          {/* Right Side — full bleed image, hidden on mobile */}
